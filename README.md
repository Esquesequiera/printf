...
A custom _printf() for learning purposes was developed by Sequiera Manasseh and WIlfred Lagat.
...
**Examples:**
- Basic String: _printf("%s Welcome", "Hello");`
...
| `s` | String of characters | Hello Welcome |
